...
<jsp:include page="/WEB-INF/jsp/common/header.jsp"><jsp:param name="pageTitle" value="Yêu cầu hoàn trả"/></jsp:include>
<%--
    PAGE: Yêu cầu hoàn trả
    ROLE: customer
    DATA: Servlet set: order, orderItems
