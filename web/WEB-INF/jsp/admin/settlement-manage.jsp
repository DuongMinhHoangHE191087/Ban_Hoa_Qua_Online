...
<div class="admin-layout">
    ...
    <main class="admin-main p-6 md:p-8 overflow-y-auto">
        ...
        <div class="flex items-center justify-between bg-gradient-to-r from-[#f0faf3] to-[#dcfce7] border border-[#bbf7d0]/60 p-6 rounded-2xl shadow-sm mb-8">
            <div>
                <h1 class="text-xl md:text-2xl font-extrabold text-[#364e03] tracking-tight">Cấu Hình Settlements Chi Tiết</h1>
                <p class="text-[#475569] text-xs md:text-sm mt-1">Cấu hình đối soát thủ công chi tiết thuộc tính năng sắp ra mắt.</p>
            </div>
        </div>
