...
<jsp:include page="/WEB-INF/jsp/common/header.jsp"><jsp:param name="pageTitle" value="Quản lý settlement"/></jsp:include>
<%--
    PAGE: Quản lý settlement
    ROLE: admin
    DATA: Servlet set: settlements
