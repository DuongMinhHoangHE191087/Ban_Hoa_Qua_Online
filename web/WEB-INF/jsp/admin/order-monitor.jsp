...
<jsp:include page="/WEB-INF/jsp/common/header.jsp"><jsp:param name="pageTitle" value="Monitor đơn hàng"/></jsp:include>
<%--
    PAGE: Monitor đơn hàng
    ROLE: admin
    DATA: Servlet set: pagedResult
