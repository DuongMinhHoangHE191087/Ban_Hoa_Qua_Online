...
<jsp:include page="/WEB-INF/jsp/common/header.jsp"><jsp:param name="pageTitle" value="Quản lý voucher"/></jsp:include>
<%--
    PAGE: Quản lý voucher
    ROLE: shop
    DATA: Servlet set: promotions
