...
<jsp:include page="/WEB-INF/jsp/common/header.jsp"><jsp:param name="pageTitle" value="Dashboard shop"/></jsp:include>
<%--
    PAGE: Dashboard shop
    ROLE: shop
    DATA: Servlet set: revenue, orderCount, lowStock, settlementStatus
