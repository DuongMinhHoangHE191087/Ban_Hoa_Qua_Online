...
<jsp:include page="/WEB-INF/jsp/common/header.jsp"><jsp:param name="pageTitle" value="Quản lý biến thể"/></jsp:include>
<%--
    PAGE: Quản lý biến thể
    ROLE: shop
    DATA: Servlet set: product, variants
