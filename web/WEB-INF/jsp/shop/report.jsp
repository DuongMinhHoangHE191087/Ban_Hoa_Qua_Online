            ...
            <form method="GET" action="${pageContext.request.contextPath}/shop/reports" class="glass-card p-5 mb-8 rounded-2xl">
                <div class="flex flex-wrap items-end gap-4">
                    ...
                    <div class="flex gap-2">
                        <button type="submit" class="bg-primary hover:bg-primary-dk text-white text-sm font-bold px-6 py-2.5 rounded-xl shadow-sm transition-all cursor-pointer border-none">
