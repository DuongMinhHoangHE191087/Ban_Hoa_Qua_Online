...
<jsp:include page="/WEB-INF/jsp/common/header.jsp"><jsp:param name="pageTitle" value="Chi tiết giao hàng"/></jsp:include>
<%--
    PAGE: Chi tiết giao hàng
    ROLE: delivery
    DATA: Servlet set: delivery, order
