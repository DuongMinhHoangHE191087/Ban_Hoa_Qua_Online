...
/**
 * HomeServlet — Controller cho chức năng: Trang chủ: sản phẩm nổi bật, danh mục
 *
 * URL: /
 * GET : Trang chủ: sản phẩm nổi bật, danh mục
 * POST: -
 *
 * QUY TẮC SERVLET:
...
public class HomeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        throw new UnsupportedOperationException("doGet not implemented: HomeServlet");
    }
