...
/**
 * ReturnRequestServlet — Controller cho chức năng: Form yêu cầu hủy/hoàn/đổi
 *
 * URL: /returns
 * GET : Form yêu cầu hủy/hoàn/đổi
 * POST: Tạo return request
 *
 * QUY TẮC SERVLET:
...
public class ReturnRequestServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        throw new UnsupportedOperationException("doGet not implemented: ReturnRequestServlet");
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        throw new UnsupportedOperationException("doPost not implemented: ReturnRequestServlet");
    }
