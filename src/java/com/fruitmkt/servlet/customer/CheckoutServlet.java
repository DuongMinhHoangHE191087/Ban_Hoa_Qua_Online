...
/**
 * CheckoutServlet — Controller cho chức năng: Form checkout: địa chỉ, phương thức TT
 *
 * URL: /checkout
 * GET : Form checkout: địa chỉ, phương thức TT
 * POST: Tạo order và khởi tạo payment
 *
 * QUY TẮC SERVLET:
...
public class CheckoutServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        throw new UnsupportedOperationException("doGet not implemented: CheckoutServlet");
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        throw new UnsupportedOperationException("doPost not implemented: CheckoutServlet");
    }
