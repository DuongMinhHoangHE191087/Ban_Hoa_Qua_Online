...
import com.fruitmkt.service.ChatService;
...
/**
 * ChatServlet — Controller cho chức năng: Danh sách chat sessions và tin nhắn
 *
 * URL: /chat
 * GET : Danh sách chat sessions và tin nhắn
 * POST: Gửi tin nhắn (fallback khi WS không dùng)
 *
 * QUY TẮC SERVLET:
...
public class ChatServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        throw new UnsupportedOperationException("doGet not implemented: ChatServlet");
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        throw new UnsupportedOperationException("doPost not implemented: ChatServlet");
    }
