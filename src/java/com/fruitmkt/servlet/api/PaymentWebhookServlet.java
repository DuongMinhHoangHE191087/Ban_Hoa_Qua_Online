...
/**
 * PaymentWebhookServlet — Controller cho chức năng: -
 *
 * URL: /api/payment/webhook
 * GET : -
 * POST: Nhận webhook từ SePay, update payment status
 *
 * QUY TẮC SERVLET:
 ...
 *   4. Forward đến /WEB-INF/jsp/api/... (không để truy cập trực tiếp)
...
public class PaymentWebhookServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        // req.getRequestDispatcher("/WEB-INF/jsp/api/xxx.jsp").forward(req, resp);
        throw new UnsupportedOperationException("doGet not implemented: PaymentWebhookServlet");
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        throw new UnsupportedOperationException("doPost not implemented: PaymentWebhookServlet");
    }
