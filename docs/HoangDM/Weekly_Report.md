...
### Nhóm: 1 | Tuần kết thúc ngày: 31-05-2026
---

> [!NOTE]
> Báo cáo tuần này tổng hợp toàn bộ lịch sử phát triển dự án **MetaFruit** từ trước đến nay, đối chiếu khớp 100% với tài liệu **SRS** (Đặc tả yêu cầu phần mềm) và **Interaction Plan** thực tế.
...
| 10 | **Product Management (CRUD)** | KhangCB | **Doing** | Đang code chức năng thêm/sửa/xóa sản phẩm và upload ảnh. |
| 11 | **Checkout & Order Placement** | HoangDM / Quan | **Doing** | Đang tích hợp địa chỉ giao hàng và quy trình tạo đơn hàng ACID. |
| 12 | **Content Moderation & Categories** | Quan | **Doing** | Đang phát triển quản trị danh mục và kiểm duyệt nội dung. |
| 13 | **Online Payment (VietQR & SePay)** | HoangDM | **To Do** | Kế hoạch tích hợp cổng QR động ngân hàng và máy thu Webhook. |
| 14 | **Order Processing & Settlement** | Duong | **To Do** | Kế hoạch code giao diện quản lý đơn hàng của Shop và Shippers. |

---

## ⚡ II. CHI TIẾT CÁC PHẦN ĐÃ HOÀN THÀNH (DONE)
*Tính đến ngày 31-05-2026*
...
## ⚙️ III. CÁC PHẦN ĐANG TRIỂN KHAI (DOING)
*Dự kiến hoàn thành trước ngày 05-06-2026*

1.  **Select Delivery Address & Checkout [Doing - Quan / HoangDM]**:
    *   Tích hợp danh sách địa chỉ giao hàng của Customer vào luồng thanh toán.
    *   Thiết kế giao diện thanh toán Glassmorphism cực kỳ cao cấp, hiển thị tóm tắt giỏ hàng, thông tin phí ship tính toán tự động.
2.  **Order Placement Transaction [Doing - HoangDM]**:
    *   Xây dựng thủ tục tạo hóa đơn giao dịch ACID trong JDBC. Khóa dòng kiểm tra kho trước khi trừ số lượng sản phẩm để chống lỗi bán quá tải (Over-selling).
3.  **Product CRUD & Multi-Image Upload [Doing - KhangCB]**:
...
4.  **Content Moderation & Categories [Doing - Quan]**:
...
*   **Xây dựng luồng xử lý đơn hàng phía Shop Owner & Shipper [In-charge: Duong]**:
    *   Giao diện Dashboard duyệt đơn, từ chối đơn hàng kèm lý do cho Shop Owner.
    *   Phân hệ Shipper nhận đơn giao hàng, cập nhật trạng thái giao thành công/thất bại.
